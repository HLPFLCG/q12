  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-gradient-to-br from-indigo-500/20 to-purple-500/10 rounded-full blur-3xl animate-pulse-glow" />
      </div>
      ...
      <div className="container relative z-10">
        <div className="flex flex-col items-center text-center pt-20 pb-16">
          ...
          {/* Subheadline */}
          <p className="animate-in delay-2 text-lg md:text-xl text-gray-400 max-w-xl mb-10">
            UGC content, social media management, and marketing strategies that
            drive real results for ambitious brands.
          </p>
          ...
          {/* Stats */}
          <div className="animate-in delay-4 flex items-center justify-center gap-10 sm:gap-16">
            {stats.map((stat) => (
